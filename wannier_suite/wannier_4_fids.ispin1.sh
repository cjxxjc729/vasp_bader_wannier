...
do
  ...
  cd $fid
    ...
    echo "wannier90.x wannier90.win &"      
    /public1/home/sch0149/tools/wannier90-2.1.0/wannier90.x wannier90.win & 
...
do
  ...
  count=0
  while ! grep -q "All done: wannier90 exiting" $fid/wannier90.wout
  do
    ((count=count+1))
    sleep 10s
